...
> [!WARNING]
> This is an inherited upstream Flatpak definition for compatibility work. The
> published Flathub application is Sunshine and does not contain SolarFlare's
> observatory UI or fork-specific performance controls. Use the
> [SolarFlare installation guide](../../../README.md#install) for this fork.
